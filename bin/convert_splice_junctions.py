...
for base_path, dirs, files in os.walk("/hive/groups/recon/projs/mus_strain_cactus/data/rel-1509-rna-seq/ftp-mouse.sanger.ac.uk/REL-1509-Assembly-RNA-Seq"):
    if files:
        ...
        file_paths = [os.path.join(base_path, x) for x in files if x.endswith(".out.tab")]
        if (genome, institute, tissue) not in file_map:
            file_map[(genome, institute, tissue)] = []
...
for (genome, institute, tissue), files in file_map.iteritems():
    target_path = os.path.join("/cluster/home/ifiddes/mus_strain_data/pipeline_data/rnaseq/munged_STAR_data/REL-1509-chromosomes", genome, institute + "_" + tissue + ".sj.bed")
...
chrom_size_base = "/cluster/home/ifiddes/mus_strain_data/pipeline_data/assemblies/1509_v2/{}.chrom.sizes"
for (genome, institute, tissue), files in file_map.iteritems():
    bed_path = os.path.join("/cluster/home/ifiddes/mus_strain_data/pipeline_data/rnaseq/munged_STAR_data/REL-1509-chromosomes", genome, institute + "_" + tissue + ".sj.bed")
    bb_path = os.path.join("/cluster/home/ifiddes/mus_strain_data/pipeline_data/rnaseq/munged_STAR_data/REL-1509-chromosomes", genome, institute + "_" + tissue + ".sj.bb")
